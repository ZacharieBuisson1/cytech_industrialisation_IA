...
On peut voir qu'il évalue l'ensemble des points mentionné ci-dessus. Ci cela ne respecte pas une certaine note, ou s'il y a une quantité qui est trop basse, le scan est en echec et l'application est considéré comme d'insuffisante qualité.
